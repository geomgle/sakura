...
const GdkRGBA gruvbox_palette[PALETTE_SIZE] = {
    {0.070588, 0.070588, 0.070588, 1.000000},  // Black (normal)
    {0.788235, 0.309804, 0.427451, 1.000000},  // Red (normal)
    {0.725490, 0.913725, 0.572549, 1.000000},  // Green (normal)
    {0.870588, 0.741176, 0.611765, 1.000000},  // Yellow (normal)
    {0.478431, 0.737255, 1.000000, 1.000000},  // Blue (normal)
    {0.541176, 0.576471, 1.000000, 1.000000},  // Magenta (normal)
    {0.611765, 0.870588, 0.870588, 1.000000},  // Cyan (normal)
    {0.874510, 0.874510, 0.874510, 1.000000},  // White (normal)
    {0.278431, 0.313725, 0.447059, 1.000000},  // Black (bright)
    {0.984314, 0.694118, 0.721569, 1.000000},  // Red (bright)
    {0.874510, 0.984314, 0.694118, 1.000000},  // Green (bright)
    {1.000000, 0.839216, 0.678431, 1.000000},  // Yellow (bright)
    {0.678431, 0.866667, 1.000000, 1.000000},  // Blue (bright)
    {0.811765, 0.678431, 1.000000, 1.000000},  // Magenta (bright)
    {0.678431, 1.000000, 1.000000, 1.000000},  // Cyan (bright)
    {0.949020, 0.949020, 0.949020, 1.000000},  // White (bright)
};
